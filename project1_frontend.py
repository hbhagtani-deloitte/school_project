...
class Student:
    ...
    def __init__(self,root):
       ...
       self.lblTit=Label(TitFrame,font=('arial',25,'bold'),text="St. Teresa Convent School Raigarh",bg="red",fg="black")
       self.lblTit.grid()

       self.lblTit=Label(TitFrame,font=('arial',12),text="(Harshita Rohra, Devanshi Pandey, Liza Parida)",bg="red",fg="black")
       self.lblTit.grid()
